  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-6 py-12">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="rounded-lg border border-line bg-surface px-3 py-2 text-fg focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
        <div className="flex flex-col gap-1">
          <label
      ...
      <button
        onClick={handleGuest}
        disabled={submitting}
        className="mt-3 rounded-lg border border-line px-4 py-2 font-medium text-fg-muted transition-colors hover:bg-surface disabled:cursor-not-allowed disabled:opacity-50"
      >
        Continue as guest
      </button>
